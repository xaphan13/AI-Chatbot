...
> Instructions for Claude Code (and other AI coding agents). If you are an AI agent, read this file first, then read the `docs/` directory — it is the single source of truth about the project. For the universal agent-agnostic version, see `AGENTS.md`.
